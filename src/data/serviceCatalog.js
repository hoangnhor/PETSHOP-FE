export const serviceCatalog = [
  {
    ...
    shortDescription: "Dịch vụ tắm rửa và chăm sóc sạch sẽ.",
    description:
      "Liệu trình spa giúp làm sạch da lông, khử mùi nhẹ và thư giãn cho thú cưng trong không gian vệ sinh tiêu chuẩn.",
    duration: "45 - 60 phút",
    species: "Chó / Mèo",
