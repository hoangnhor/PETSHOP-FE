...
const FooterComponent = () => {
    return (
        ...
        >
            ...
            >
                <div>
                    <h2 style={{ margin: "0 0 10px", color: "#F8F5F0", fontSize: 36, letterSpacing: ".04em" }}>MaisonPet</h2>
                ...
                <div>
                    ...
                    <p>
                        Email: <a style={{ color: "#C6A969" }} href="mailto:contact@petstore.com">contact@petstore.com</a>
                    </p>
                    <p>
